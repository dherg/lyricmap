  ...
  render() {
    return (
        <div id="About-Page-Content">
            ...
            <p>
                Feedback/comments/questions are all welcome! <a href="https://github.com/dherg/lyricmap"> Check out the code on Github </a> and create an issue (or pull request!) if something's broken. 
            </p>
